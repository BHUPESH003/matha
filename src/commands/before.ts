...
const operationTypeMap: Record<string, SessionContext['operationType']> = {
  '1': 'rename',
  '2': 'crud',
  '3': 'business_logic',
  '4': 'architecture',
...
const modelTierBudget: Record<SessionContext['operationType'], { modelTier: string; tokenBudget: number }> = {
...
async function runBefore(projectRoot: string = process.cwd(), deps?: BeforeDeps): Promise<BeforeResult> {
